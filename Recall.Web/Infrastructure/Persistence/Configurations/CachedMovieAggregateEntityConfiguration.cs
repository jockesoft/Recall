...
public sealed class CachedMovieAggregateEntityConfiguration : IEntityTypeConfiguration<CachedMovieAggregateEntity>
{
    public void Configure(EntityTypeBuilder<CachedMovieAggregateEntity> builder)
    {
        builder.ToTable("cached_movie_aggregate");
