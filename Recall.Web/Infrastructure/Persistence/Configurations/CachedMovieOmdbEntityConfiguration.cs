...
public sealed class CachedMovieOmdbEntityConfiguration : IEntityTypeConfiguration<CachedMovieOmdbEntity>
{
    public void Configure(EntityTypeBuilder<CachedMovieOmdbEntity> builder)
    {
        builder.ToTable("cached_movie_omdb");
        ...
        builder.HasIndex(x => x.RetrievedUtc)
            .HasDatabaseName("ix_cached_movie_omdb_retrieved_utc");
    }
}
